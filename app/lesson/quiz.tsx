...
import Connfetti from "react-confetti";
      ...
      <div className="flex-1">
        <div className="h-full flex items-center justify-center bg">
          <div className="lg:min-h-[350px] lg:w-[600px] w-full px-6 lg:px-0 flex flex-col gap-y-12">
            <h1 className="text-lg lg:text-3xl text-center lg:text-start font-bold text-neutral-700 break-words whitespace-normal">
              {title}
            </h1>
            <div>
